% Plot 2D Gaussian in 3D
% * Permute the parallel dimensions out to the third and fourth,
% * use bsxfun to do the broadcasting, 
% * then bring the results back. It involves a few shiftdim operations
